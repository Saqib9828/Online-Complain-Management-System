...
AttachDbFilename=C:\USERS\SAKIB\DESKTOP\OCMS\OCMS\APP_DATA\OCMS.MDF;Integrated Security=True;User Instance=True");
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sqlcmd = new SqlCommand("insert into Police_Data(BatchID,Password,Name,Father_Name,DOB,Gender,Education,Exp,SPCL,AOI,State,Post,Address,Contact,Email,Admin,Photo) values('" + TextBox7.Text + "','" + TextBox15.Text + "','" + TextBox1.Text + "','" + TextBox14.Text + "','" + TextBox2.Text + "','" + DropDownList2.Text + "','" + DropDownList3.Text + "','" + TextBox13.Text + "','" + DropDownList4.Text + "','" + TextBox6.Text + "','" + DropDownList6.Text + "','" + DropDownList5.Text + "','" + TextBox9.Text + "','" + TextBox4.Text + "','" + TextBox8.Text + "','" + TextBox16.Text + "','" + FileUpload1.FileContent + "')", sqlcon);
            sqlcon.Open();
